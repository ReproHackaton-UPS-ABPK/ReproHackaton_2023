...
paths <- c("C:/Users/afons/Downloads/SRR10379721.txt", "C:/Users/afons/Downloads/SRR10379722.txt",
           "C:/Users/afons/Downloads/SRR10379723.txt", "C:/Users/afons/Downloads/SRR10379724.txt",
           "C:/Users/afons/Downloads/SRR10379725.txt", "C:/Users/afons/Downloads/SRR10379726.txt")
...
tableCounts <- data.frame(sample1 = ensembleCounts[[1]]$mapped.SRR10379721.bam,
                          sample2 = ensembleCounts[[2]]$mapped.SRR10379722.bam, sample3 = ensembleCounts[[3]]$mapped.SRR10379723.bam,
                          sample4 = ensembleCounts[[4]]$mapped.SRR10379724.bam, sample5 = ensembleCounts[[5]]$mapped.SRR10379725.bam,
                          sample6 = ensembleCounts[[6]]$mapped.SRR10379726.bam)
...
#all(rownames(type_tab) %in% colnames(tableCounts))
#all(rownames(type_tab) == colnames(tableCounts))
...
vecteur_translation = read.table("C:/Users/afons/Downloads/translation.txt", sep = "\t", header = F)
